...
export class BasketsComponent extends BaseComponent implements OnInit{
  ...
  constructor(spinner: NgxSpinnerService, private basketService: BasketService, private orderService: OrderService, private customToastrService: CustomToastrService, private router: Router, private dialogService: DialogService) { 
    super(spinner);
  }
  ...
  async changeQuantity(object: any) {
    ...
    await this.basketService.changeQuantity(basketItem);
    this.hideSpinner(SpinnerType.BallAtom);
  }
  ...
  async shoppingComplete() {
    ...
    this.dialogService.openDialog({
      ...
      afterClosed: async() => {
        ...
        order.address = "Yenibağlar mahallesi";
        order.description = "Güzel bir sipariş";
